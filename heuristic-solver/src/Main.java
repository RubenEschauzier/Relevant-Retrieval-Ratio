...
public class Main {
	...
	public static void main(String[] args) {
		// Run command as follows: arg1 = steinLibMainDir, arg2 = steinLibSubDir
		// javac Main.java && java Main "../SteinLib/" "Btest/"
		// We test that algorithm
		// createStronglyConnectedInstances("../SteinLib", "/B", "target");
		...
		String steinLibMainDir = args[0];
		String steinLibSubDir = args[1];
...
//			exampleLaunchStronglyTest();
	...
	public static void testAlgorithm(String steinLibMainDir,
		...
		for (int i = nbInstancesIgnored; i < gen.getNumberOfInstances(); i++) {
			...
			System.out.println("\n");
			for (Arc edge : alg.getArborescence()) { 
				System.out.println("A " + edge.getInput() + " " + edge.getOutput()); 
			}
			System.out.println("\n");
